# PROJECT 3 - PART A.2
# USING NEURAL NETWORK FOR THE SAME DATASET
...
# Train a network for a fixed number of epochs for regression
...
# Normalize dataset
salary_data = (salary_data - salary_data.min())/(salary_data.max()-salary_data.min())
dataset = salary_data.values.tolist()

# Training the network
n_inputs = len(dataset[0]) - 1
n_outputs = 1 # Because for regression we have a single output
